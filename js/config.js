...
window.SITE_CONFIG = {
    ...
    carrossel: [
        ...
        { imagem: "images/slide3-cachorros.jpg", alt: "Dois cães clientes da Pet da Pri, sorridentes após o atendimento", titulo: "Cada cão, um cuidado especial", subtitulo: "Clientes que já confiam na Pet da Pri.", posicao: "center 20%" },
    ],
};
